...
1. **The synchronizer is permissioned.** Synchronizer access must be changed to a permissioned model that allows banning malicious or misbehaving participants and prevents them from re-joining at near-zero cost.
